    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-text-input id="email" class="block mt-1 w-full" placeholder="Type your email here" type="email" name="email" :value="old('email')" required autofocus />
            ...
            <div class="flex items-center justify-between mt-4 text-primary ">
